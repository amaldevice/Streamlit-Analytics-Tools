...
def main():
    ...
    # User Choice: Direct Forecasting or Preprocessing & Visualization
    user_choice = st.radio(
        "Pilih opsi berikut:",
        ('Lanjut Peramalan', 'Lanjut Analisis Data'),
        index=None,  # Default to preprocessing and visualization
        help="Pilih 'Lanjut Peramalan' untuk melewati tahap preprocessing dan visualisasi, atau pilih 'Lanjut Analisis Data' untuk melakukan analisis data terlebih dahulu."
    )

    if user_choice == 'Lanjut Analisis Data':
        # Pembersihan Data
        ...
        # Option to proceed to forecasting
        lanjut = st.radio(
            "Apakah Anda ingin melanjutkan ke tahap peramalan?",
            ('Ya', 'Tidak'),
            index=None,
            help="Pilih 'Ya' untuk melanjutkan ke tahap peramalan atau 'Tidak' untuk mengakhiri analisis."
        )
    ...
    elif user_choice == 'Lanjut Peramalan':
        perform_forecasting(df)
    else:
        st.warning("Pilih opsi yang tersedia.")
        st.stop()
...
def perform_forecasting(df):
    methods = st.radio("Pilih Metode Peramalan", ('Time Series', 'Regression'), index=None,
                       help="""
                            Time Series adalah peramalan menggunakan data historis / 
                            Regresi adalah peramalan menggunakan beberapa variabel lain yang mempengaruhi variabel yang ingin diprediksi""")
